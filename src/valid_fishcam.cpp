...
int main(int argc, char** argv)
{
  ...
  // R_FR_BL << -0.0140637,-0.0132291,-0.999814,
  //            -0.0201349,0.999713,-0.0129446,
  //            0.999698,0.0199491,-0.014326;
  // R_FR_FL << -0.999615,-0.0214161,-0.0176244,
  //            -0.0216788,0.999655,0.0148523,
  //            0.0173003,0.0152287,-0.999734;
  // R_FR_BR << -0.017033,-0.00615865,0.999836,
  //            -0.00746731,0.999954,0.00603217,
  //            -0.999827,-0.00736334,-0.0170782;
  // Vector3d t_FR_BL(-0.102366, 0.00964892, -0.138611);
  // Vector3d t_FR_FL(0.0424928, 0.00620752, -0.229368);
  // Vector3d t_FR_BR(0.189354, 0.00498936, -0.0795464);
